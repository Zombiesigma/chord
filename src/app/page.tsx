...
/*
 * Selalu render ulang halaman menggunakan
 * data terbaru dari Firebase Firestore.
 *
 * Ini penting karena data lagu bisa berubah
 * langsung dari aplikasi/Firebase.
 */
    ...
    <main className="min-h-screen bg-[#050505] text-zinc-100">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-12 pt-20">
        ...
        <p className="mt-6 max-w-xl text-zinc-400">
          Chord dan lirik langsung dari database musik kamu.
          Satu data untuk aplikasi dan website.
        </p>
      </section>
