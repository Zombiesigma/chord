...
export default async function Home() {
  ...
  /*
   * Ambil artist unik dari data lagu.
   */
  ...
  for (const song of songs) {
    ...
    if (existing) {
      ...
      if (
        ...
        existing.cover = song.coverImageUrl;
      }
    } else {
  ...
  /*
   * Lagu pertama dipakai sebagai visual hero.
   */
      ...
      <section className="relative isolate mx-auto max-w-7xl px-5 pt-8 sm:pt-12 lg:px-8 lg:pt-16">
        <div className="relative min-h-[560px] overflow-hidden rounded-[30px] border border-white/[0.07] bg-[#090909] sm:min-h-[600px] lg:min-h-[620px]">
          ...
          {heroSong?.coverImageUrl && (
            <>
              <div
                className="absolute inset-0 bg-cover bg-center opacity-[0.13] blur-[1px]"
                style={{
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden bg-zinc-900">
                  {song.coverImageUrl ? (
                    ...
                    <div className="flex h-full items-center justify-center text-xs font-bold tracking-widest text-zinc-700">
                      NO COVER
                    </div>
                  )}
            ...
            >
              <div className="h-[62px] w-[62px] shrink-0 overflow-hidden rounded-xl bg-zinc-900">
                {song.coverImageUrl ? (
                  ...
                  <div className="flex h-full items-center justify-center text-[8px] font-bold text-zinc-700">
                    NO
                  </div>
                )}
              </div>
